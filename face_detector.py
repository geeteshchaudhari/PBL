...
def get_face_detector(modelFile=None,
    ...
    if quantized:
        ...
        if modelFile == None:
            modelFile = r"C:\Users\geete\Desktop\PBL\venv\vardhan_agrawal\Proctoring-AI\models/res10_300x300_ssd_iter_140000.caffemodel"
        if configFile == None:
            configFile = r"C:\Users\geete\Desktop\PBL\venv\vardhan_agrawal\Proctoring-AI\models/deploy.prototxt"
